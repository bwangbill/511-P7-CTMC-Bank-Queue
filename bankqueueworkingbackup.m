...
timestamp=0; %tracks arrival timestamps
time1=0; %tracks server 1 timestamps
time2=0; %tracks server 2 timestamps
time3=0; %tracks server 3 timestamps
...
while (ss>0) %while customers are remaining in buffer
